...
# Adicione este script ao cron com: 20 00 * * * /opt/bin/alfresco-bkp.sh

ALF_HOME="/opt/alfresco-community"
LOCAL_BKP="/opt/bkp/alfresco"
REMOTE_BKP="/opt/win-server/usb/bkpAlfresco"
...
BKP_RP="/opt/win-server/usb/bkpAlfresco/alfresco-community/alf_data"

#Local & Remote LetsEncrypt Certificates
CERTS_LOCAL="/etc/letsencrypt/live/alfresco.cpn.com.br/"
CERTS_REMOTE="/opt/win-server/d/TI/letsencrypt/certs/live/alfresco.cpn.com.br"
...
rsync -ar --delete-after --stats $ACTIVE_RP/contentstore/ $BKP_RP/contentstore/ >> $LOGFILE

printf "\n\nRelatório do diretório .../solr4/" >> $LOGFILE
rsync -ar --delete-after --stats $ACTIVE_RP/solr4/ $BKP_RP/solr4/ >> $LOGFILE
printf "ok"
...
rsync -avrL $CERTS_LOCAL $CERTS_REMOTE
printf "ok"
